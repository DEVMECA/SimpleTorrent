...
{
    public static final String NOTIFY_ACTION_SHUTDOWN_APP = "com.devmeca.simpletorrent.receivers.NotificationReceiver.NOTIFY_ACTION_SHUTDOWN_APP";
    public static final String NOTIFY_ACTION_ADD_TORRENT = "com.devmeca.simpletorrent.receivers.NotificationReceiver.NOTIFY_ACTION_ADD_TORRENT";
    public static final String NOTIFY_ACTION_PAUSE_ALL = "com.devmeca.simpletorrent.receivers.NotificationReceiver.NOTIFY_ACTION_PAUSE_ALL";
    public static final String NOTIFY_ACTION_RESUME_ALL = "com.devmeca.simpletorrent.receivers.NotificationReceiver.NOTIFY_ACTION_RESUME_ALL";
